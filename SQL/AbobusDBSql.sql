...
ALTER TABLE AbobusDB.dbo.Applications ADD CONSTRAINT fk_Application_ApplicationTypes FOREIGN KEY ( id_aplicationtype ) REFERENCES AbobusDB.dbo.ApplicationTypes( id_applicationtype );
GO
